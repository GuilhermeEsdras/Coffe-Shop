            ...
            try {
                ...
                switch (opcao) {
                    ...
                    case 4:
                        ...
                        if (divisao == 0) System.out.println("Impossivel dividir por zero.");
                        else System.out.println("A divisão de " + numeros[0] + " e " + numeros[1] + " é: " + divisao);
                        break;
                ...
                System.out.println("Erro! Use numeros e virgula para separar.");
            }
